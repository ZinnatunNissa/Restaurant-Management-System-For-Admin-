<?php 
     ...
     if(isset($_POST["update_manager"]))	 
	 {
			 ...
			 if(!$hasError){
				 updatemanager($name,$email,$phone,$address,$jday,$jmon,$jyr,$gender);
			 }
		 }
			function updatemanager($name,$email,$phone,$address,$jday,$jmon,$jyr,$gender){
			 $query="UPDATE MANAGERS SET email='$email', phone='$phone', address='$address', jday='$jday',
			 jmon='$jmon', jyr='$jyr', gender='$gender' WHERE name='$name'";
			 execute($query);
			 } 
?>