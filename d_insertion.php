<?php
     include 'controllers/D_InsertionController.php';
?>
<html>
     <head></head>
	 <body>
	  <style > body{
	      ...
	      <fieldset>
              <legend align="center"><h1>DeliveryMan Insertion</h1></legend>
		       <form action="" onsubmit="return validateDeliveryman()" method="post">
		       <table align="center", border ="3" cellpadding="20", cellspacing="5">
					...
					<tr>
					    <th><span>NID Submission</span></th>
						<td><textarea name="nid" id="nid" placeholder="Provide NID Copy"></textarea>
						<span id="err_nid"><?php echo $err_nid;?></span></td>
					</tr>
					<tr>
						<td colspan="2"><input class="my-font btn-mine"type="submit" name="d_add" value="Add"></td>
					</tr>
			  </table>
		</form>
	</fieldset>
