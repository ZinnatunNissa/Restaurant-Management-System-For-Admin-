<?php
     include 'controllers/UpdateManagerController.php';
?>
<html>
     <head></head>
	 <body>
	  <style > body{
	      ...
	      <fieldset>
              <legend align="center"><h1>Manager Info Update</h1></legend>
		       ...
		       <table align="center", border ="5" cellpadding="25", cellspacing="5">
					...
					<tr>
						<td colspan="2"><input class="my-font btn-mine"type="submit" name="update_manager" value="Update"></td>
					</tr>
			  </table>
		</form>
	</fieldset>
